...
Este script usa una versión mínima de **2.2.0.0** para el módulo de protección de RMS. Ejecute el siguiente comando para comprobar la versión: `(Get-Module RMSProtection -ListAvailable).Version` 
