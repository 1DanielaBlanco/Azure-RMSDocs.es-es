...
## <a name="whats-the-difference-between-generic-protection-and-builtin-native-protection"></a>¿Cuál es la diferencia entre la protección genérica y la protección incorporada (nativa)?
