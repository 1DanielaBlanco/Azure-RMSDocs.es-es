...
description: "Para quitar la protección (es decir, desproteger) de un archivo protegido anteriormente con la aplicación de RMS sharing, use la opción Quitar protección en el Explorador de archivos."
author: cabailey
manager: mbaldwin
ms.date: 07/13/2016
ms.topic: article
