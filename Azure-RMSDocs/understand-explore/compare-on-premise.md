...
> [!NOTE]
> Para facilitar esta comparación, parte de la información que se encuentra aquí se repite de [Requisitos de Azure Information Protection](../get-started/requirements-azure-rms.md). Use este artículo para obtener soporte más específico e información de la versión para Azure Rights Management.
