---
title: 'Escenario de AIP: controlar los documentos almacenados en SharePoint'
...
2.  Seleccione lo siguiente:
    ...
    -   Opcional: **Permitir la protección de grupos. Grupo predeterminado** y, luego, especifique el nombre de un grupo adicional que puede que necesite colaborar en documentos almacenados en esta biblioteca, pero fuera de SharePoint. Por ejemplo, el grupo de ventas tiene permisos de edición en el sitio y alguien de este grupo descarga un documento, lo guarda en el disco y lo envía por correo electrónico a una compañera de trabajo. La compañera de trabajo solo tendrá acceso al documento (con derechos de edición) si es miembro del grupo diseñado.
