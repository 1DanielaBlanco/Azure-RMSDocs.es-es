...
description: Identifique las aplicaciones compatibles de forma nativa con Azure RMS, lo que significa que RMS se integra estrechamente en estas aplicaciones mediante las API de RMS para admitir restricciones de uso.
author: cabailey
manager: mbaldwin
ms.date: 08/25/2016
