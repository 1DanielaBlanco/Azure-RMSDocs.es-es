...
description: Identifique los requisitos de Azure AD para usar Azure Rights Management (Azure RMS), para que los usuarios puedan autenticarse correctamente.
author: cabailey
manager: mbaldwin
ms.date: 08/25/2016
