...
<article id="main">
    <section id="hero-content">
      ...
      <h2>Aquí puede encontrar todo lo que necesita saber para implementar y administrar Azure Rights Management (Azure RMS). Le ayudaremos a empezar a usar rápidamente Azure RMS para aplicar la protección de información a correos electrónicos, documentos y otros datos confidenciales.</h2>
