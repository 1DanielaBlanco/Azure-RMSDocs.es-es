        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Vea las sesiones de Azure Information Protection de Microsoft Ignite 2018</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <p><a href="/information-protection/develop/developers-guide">Guía del desarrollador</a></p>
                    </div>
                </div>
            </div>
        </div>
