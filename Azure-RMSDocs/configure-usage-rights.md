...
Nota: Si ve referencias a **DecryptAttachmentFromPortal**, sepa que este parámetro está en desuso para [Set-IRMConfiguration](/powershell/module/exchange/encryption-and-certificates/set-irmconfiguration?view=exchange-ps) y ya no está disponible.
