...
Siga estas instrucciones si quiere activar el servicio Azure Rights Management (Azure RMS) desde Azure Portal. Este método de activación está actualmente en vista previa.
