...
4. Ejecute el comando [Get-IRMConfiguration](https://technet.microsoft.com/library/dd776120(v=exchg.160\).aspx) para ver la configuración de Exchange Online del servicio de protección:
