...
7. Seleccione una de las siguientes opciones:
    ...
    Sugerencia: Si usa el botón **Editar plantilla**, puede resultarle útil ver [Tareas que solía realizar con el Portal de Azure clásico](migrate-portal.md).
