...
4. Haga clic en **Microsoft Azure Rights Management**.
    ...
    > [!NOTE]
    >Dependiendo de la pantalla, debe desplazarse para ver esta opción. Si aun así no aparece, podría deberse a que su plan de servicio o la versión del producto no incluyen [!INCLUDE[aad_rightsmanagement_2](../includes/aad_rightsmanagement_2_md.md)].
    >
