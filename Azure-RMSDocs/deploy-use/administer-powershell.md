...
description: "Obtenga información sobre cómo puede usar el módulo de Windows PowerShell para Azure RMS (AADRM) para administrar este servicio para la organización."
author: cabailey
manager: mbaldwin
ms.date: 08/25/2016
ms.topic: article
