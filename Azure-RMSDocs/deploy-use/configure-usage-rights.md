...
|Nombre común: **Reenviar** <br /><br />Codificación en la directiva: **FORWARD**|Habilita la opción para reenviar un mensaje de correo electrónico y agregar destinatarios a las líneas **Para** y **CO** . Este derecho no se aplica a documentos, solo a mensajes de correo electrónico.<br /><br />No permite que el reenviador conceda derechos a otros usuarios como parte de la acción de reenvío. <br /><br />Nota: Cuando se envía un correo electrónico a otra organización, el cliente de Outlook o la aplicación web de Outlook del destinatario requiere el derecho **Editar contenido, Editar** (nombre común), además de Reenviar.|Derechos personalizados de Office: se deniega al usar la directiva estándar **No reenviar**.<br /><br />Nombre en el Portal de Azure clásico: **Reenviar**<br /><br />Nombre en las plantillas de AD RMS: **Reenviar** <br /><br />Constante o valor de API: `IPC_EMAIL_FORWARD L"FORWARD"`|
...
|Nombre común: **Responder** <br /><br />Codificación en la directiva: **REPLY**|Habilita la opción **Responder** en un cliente de correo electrónico, sin permitir que se realicen cambios en las líneas **Para** o **CC**.<br /><br />Nota: Cuando se envía un correo electrónico a otra organización, el cliente de Outlook o la aplicación web de Outlook del destinatario requiere el derecho **Editar contenido, Editar** (nombre común), además de Responder.|Derechos personalizados de Office: no aplicables.<br /><br />Nombre en el Portal de Azure clásico: **Responder**<br /><br />Nombre en las plantillas de AD RMS: **Responder** <br /><br />Constante o valor de API: `IPC_EMAIL_REPLY`|
|Nombre común: **Responder a todos** <br /><br />Codificación en la directiva: **REPLYALL**|Habilita la opción **Responder a todos** en un cliente de correo electrónico, pero no permite al usuario agregar a destinatarios a las líneas **Para** o **CO** .<br /><br />Nota: Cuando se envía un correo electrónico a otra organización, el cliente de Outlook o la aplicación web de Outlook del destinatario requiere el derecho **Editar contenido, Editar** (nombre común), además de Responder a todos.|Derechos personalizados de Office: no aplicables.<br /><br />Nombre en el Portal de Azure clásico: **Responder a todos**<br /><br />Nombre en las plantillas de AD RMS: **Responder a todos** <br /><br />Constante o valor de API: `IPC_EMAIL_REPLYALL L"REPLYALL"`|
...
|---------------------|----------------|---------------------------------|
|Visor|Portal de Azure clásico<br /><br />Aplicación de uso compartido Rights Management para Windows<br /><br />Cliente de Azure Information Protection para Windows|Ver, Abrir, Leer; Responder; Responder a todos<br /><br />Nota: No utilice este nivel de permiso para Responder o Responder a todos cuando envíe un correo electrónico a otra organización y el destinatario utilice Outlook o la aplicación web de Outlook. En su lugar, utilice Revisor, que incluye el derecho **Editar contenido, Editar** (nombre común), que requieren estos clientes de correo electrónico para responder.|
