...
1. Asegúrese de iniciar sesión en el Portal de Azure mediante este vínculo especial de Azure Information Protection: https://portal.azure.com/?microsoft_azure_informationprotection=true
...
3. En la hoja **Azure Information Protection**, seleccione la etiqueta que quiere configurar para clasificación automática o recomendada.
...
5. En la hoja **Condición**, seleccione **Built-in** (Integrada) si quiere usar una condición predefinida, o **Personalizada** si quiere especificar la suya propia, y luego haga clic en **Guardar**:
