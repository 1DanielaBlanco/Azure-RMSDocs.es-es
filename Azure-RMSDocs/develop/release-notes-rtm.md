...
-   **Actualizaciones de la documentación**
    ...
    **Reorganización** de [procedimientos](how-to-use-msipc.md) para aclarar el orden de los pasos para la configuración del entorno y para las pruebas de la aplicación.
