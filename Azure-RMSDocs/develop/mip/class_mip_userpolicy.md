...
public std::shared_ptr<TemplateDescriptor> GetTemplateDescriptor()  |  Obtiene [TemplateDescriptor](#classmip_1_1_template_descriptor) para una clase [UserPolicy](#classmip_1_1_user_policy) basada en plantilla.
public std::shared_ptr<PolicyDescriptor> GetPolicyDescriptor()  |  Obtiene [PolicyDescriptor](#classmip_1_1_policy_descriptor) para una clase [UserPolicy](#classmip_1_1_user_policy) ad hoc.
...
public const std::vector<unsigned char> GetSerializedPolicy()  |  Serializa [UserPolicy](#classmip_1_1_user_policy) en una licencia de publicación (PL)
public std::shared_ptr<rmscore::core::ProtectionPolicy> GetImpl()  |  Obtiene la implementación de clase derivada interna de [UserPolicy](#classmip_1_1_user_policy).
