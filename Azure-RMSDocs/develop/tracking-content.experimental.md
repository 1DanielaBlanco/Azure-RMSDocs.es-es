...
En este tema se abordan las instrucciones básicas para implementar el seguimiento de documentos, así como código de ejemplo para las actualizaciones de metadatos y para la creación de un botón [**Hacer seguimiento de uso**](#add-a-track-usage-button-to-your-app) para la aplicación.
