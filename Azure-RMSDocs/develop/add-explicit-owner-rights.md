...
title: Incorporación de derechos de propiedad explícitos | Azure RMS
...
**Nota:** configure un usuario como "propietario" con [**IpcSetLicenseProperty**](/rights-management/sdk/2.1/api/win/functions#msipc_ipcsetlicenseproperty) con la propiedad **IPC\_LI\_OWNER** que no concede al propietario todos los permisos.

 
## Escenario: Asignación de derechos a una licencia

En este ejemplo de C++, los derechos necesarios se agregan a una licencia creada con [**IpcCreateLicenseFromScratch**](/rights-management/sdk/2.1/api/win/functions#msipc_ipccreatelicensefromscratch). El ejemplo muestra la creación y asignación de los derechos de la licencia a través de una lista de derechos.
...
**Nota:** este ejemplo de código solo muestra los pasos necesarios para crear y agregar derechos específicos a una licencia determinada.
