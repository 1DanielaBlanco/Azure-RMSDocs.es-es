...
3. Habilite la función IRM para Exchange mediante la [habilitación de IRM para los mensajes internos](https://technet.microsoft.com/library/bb124077(v=exchg.150\).aspx#Anchor_1).
